  ...
  <v-app id="inspire" >
    <v-navigation-drawer v-model="drawer" app >
      <v-list dense>
        ...
        <v-list-item link href="https://developers.google.com/community/gdg" target="_blank">
          <v-list-item-action>
            <v-icon color="blue">
              mdi-account-alert
            </v-icon>
    ...
    <v-app-bar  app >
      ...
      <v-img  alt="GDG LOGO"  class="shrink mr-2"  contain src="./assets/GDG-Logo.png" transition="scale-transition" width="40"  />
